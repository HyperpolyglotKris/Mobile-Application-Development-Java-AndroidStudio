...
public class Database implements Parcelable {
    ...
    // CLASSES DATABASE
    static Classes class1 = new Classes("Ramen", R.drawable.ramenmenu);
    static Classes class2 = new Classes("Dumplings", R.drawable.dumplingsmenu);
    static Classes class3 = new Classes("Sushi", R.drawable.sushimenu);
    static Classes class4 = new Classes("BubbleTea", R.drawable.bubbleteamenu);

    static ArrayList<Classes> classesArrayList = new ArrayList<>();
    static {
        classesArrayList.add(class1);
        classesArrayList.add(class2);
        classesArrayList.add(class3);
        classesArrayList.add(class4);
    }
